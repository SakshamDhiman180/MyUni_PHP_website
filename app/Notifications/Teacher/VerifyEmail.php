    ...
    protected function verificationUrl($notifiable)
    {
        ...
        return URL::temporarySignedRoute(
            ...
            [
                ...
                'user_type' => config('constants.userType.teacher')
            ]
        );
    }
    ...
    protected function buildMailMessage2($url, $notifiable)
    {
        if (isset($notifiable->password1) && $notifiable->password1 != "") {
            return (new MailMessage)
                ...
                ->line(new HtmlString('Your login password is <b>' . ($notifiable->password1 ?? '') . '</b>'))
                ->line(Lang::get('This password is auto generated by our system.'))
