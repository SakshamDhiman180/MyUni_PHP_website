...
class ResetPasswordController extends Controller
{
    ...
    */
    ...
    public function showResetForm(Request $request)
    {
        ...
        return view('common.auth.passwords.reset')->with(
    ...
    public function reset(Request $request)
    {
        ...
        if (Password::INVALID_USER == $response) {
            $response = $this->teacherBroker()->reset(
                $this->credentials($request),
                function ($user, $password) {
                    $this->resetPassword($user, $password);
                }
    ...
    protected function sendResetResponse(Request $request, $response)
    {
        ...
        return redirect(route('common.signin'))->with('success', trans($response));
    }
    ...
    //broker for teacher
    protected function teacherBroker()
    {
