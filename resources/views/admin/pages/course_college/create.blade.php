            ...
            <div class="row">
                <div class="col-12 mx-auto">
                    <div class="card card-body mt-4">
                        ...
                        <form method="post" action="{{ route('cource_college.store') }}" autocomplete="off">
                            @csrf
                            @method('post')
                            <div class="col-md-12">
                                 ...
                                 required>
                                    ...
                                    @foreach ($courseList as $data)
                                        <option value="{{ $data->id }}"
                                            {{ $data->id == ($teacher->country_id ?? 0) ? 'selected' : '' }}>
                                            {{ $data->name }}
                                        </option>
                                    @endforeach
                                </x-form.select>
                            ...
                            <div class="col-md-12">
                                <x-form.input class="col-form-label pt-0" type="text" labelname="Fees (in Rupees)"
                                    placeholder="fees" attribute="fee" id="" value="" required />
