            ...
            <div class="col-12 mx-auto">
                <div class="card card-body mt-4">
                    ...
                    <form method="post" action="{{ route('roles.store') }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('post')
                        <x-form.input type="text" attribute="name" placeholder="{{ __('Name') }}" required="true" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="form-check">
                                                    <x-common.checkbox attribute="permission[]" class="form-check-input float-none" value="{{ $permission['permissions'][$name] }}" />
                                                </span>
                                                @else
                                                -
                                                @endif
